  ...
  return (
    <main className={`bg-white relative flex flex-col min-h-screen overflow-hidden ${sourceSerif.className}`}>
      ...
      >
        {/* Ana Buton */}
        <div
          className={`bg-gradient-to-tr from-gray-500 via-gray-300 to-gray-500 text-center text-xl font-bold uppercase tracking-widest -rotate-90 rounded-t-md shadow-main cursor-pointer px-6 py-2 transition-all duration-500 ${
        ...
        {/* Açılan Butonlar */}
        <div
          className={`absolute right-14 top-1/2 -translate-y-1/2 flex flex-col gap-4 rounded-l-md p-3 transition-all duration-500 origin-right ${
            poppins.className
          } ${showOptions ? "translate-x-0 opacity-100 pointer-events-auto" : "translate-x-full opacity-0 pointer-events-none"}`}
        >
          <Link
            href="https://wa.me/905053679077?text=Merhaba%2C%20bir%20konu%20hakk%C4%B1nda%20hukuki%20yard%C4%B1ma%20ihtiyac%C4%B1m%20var.%20Yard%C4%B1mc%C4%B1%20olabilir%20misiniz%3F"
            target="_blank"
          ...
          >
            ...
            <span className="text-[11px] font-semibold">Telefon</span>
          </Link>
          <Link
            href="mailto:kocamanhukuk@gmail.com"
          ...
          >
            ...
            <span className="text-[11px] font-semibold">E-posta</span>
          </Link>
        </div>
      </div>
      ...
      {/* DOCK */}
      <div
        className={`md:hidden fixed inset-x-0 bottom-0 z-40 shadow-main bg-gradient-to-br from-gray-500 via-gray-300 to-gray-500 ${poppins.className}`}
      >
        <ul className="h-14 flex items-center justify-between max-w-screen-xl mx-auto uppercase font-medium">
          ...
          <li className="h-full basis-1/4">
            <Link
              href="mailto:kocamanhukuk@gmail.com"
              className="h-full w-full flex flex-col items-center justify-center gap-1 text-cyan-600 pt-1"
            >
              <FaEnvelope className="text-xl" />
      ...
      >
        <div
          onClick={scrollToTop}
          className="bg-gradient-to-tr from-gray-500 via-gray-300 to-gray-500 rounded-md shadow-main cursor-pointer p-4"
        >
          <FaChevronUp />
        </div>
      </div>
